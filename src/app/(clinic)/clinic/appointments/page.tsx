                        ...
                        <div className="relative" onClick={(e) => e.stopPropagation()}>
                          {updatingId === apt.id ? (
                            ...
                            <>
                              ...
                              {openDropdown === apt.id && (
                                <div className="absolute right-0 top-full mt-1 bg-white rounded-lg shadow-xl border z-20 py-1 min-w-[180px]">
                                  {Object.entries(statusLabels).map(([value, label]) => (
                                    <button
                                      ...
                                      className={`w-full px-3 py-2.5 text-left text-sm font-medium hover:bg-gray-100 flex items-center gap-3 ${apt.status === value ? 'bg-blue-50' : ''}`}
                                    >
                                      <span className={`w-3 h-3 rounded-full ${statusColors[value]?.split(' ')[0] || 'bg-gray-400'}`}></span>
