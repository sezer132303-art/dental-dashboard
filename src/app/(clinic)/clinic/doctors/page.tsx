    ...
    const fetchDoctors = async () => {
      try {
        ...
        if (doctorsData.doctors) {
          // Merge doctor data with metrics if available
          const mergedDoctors = doctorsData.doctors.map((doctor: Doctor) => {
            const stats = metricsData.doctors?.find((d: Doctor) => d.id === doctor.id)
            return {
              ...doctor,
          ...
          >
            <div className="p-6">
              <div className="flex items-start gap-4">
                <div className={cn('w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold', doctor.color || 'bg-teal-500')}>
              ...
              <div className="mt-4 grid grid-cols-3 gap-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <p className="text-2xl font-bold text-teal-600">{doctor.patientsThisWeek || 0}</p>
